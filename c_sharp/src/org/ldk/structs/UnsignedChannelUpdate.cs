...
public class UnsignedChannelUpdate : CommonBase {
	...
	public void set_chain_hash(byte[] val) {
		Bindings.UnsignedChannelUpdateSetChainHash(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 32)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
