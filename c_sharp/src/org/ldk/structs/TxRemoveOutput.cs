...
public class TxRemoveOutput : CommonBase {
	...
	public void set_channel_id(byte[] val) {
		Bindings.TxRemoveOutputSetChannelId(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 32)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public static TxRemoveOutput of(byte[] channel_id_arg, long serial_id_arg) {
		long ret = Bindings.TxRemoveOutputNew(InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(channel_id_arg, 32)), serial_id_arg);
