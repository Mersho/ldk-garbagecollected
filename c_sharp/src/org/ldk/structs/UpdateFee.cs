...
public class UpdateFee : CommonBase {
	...
	public void set_channel_id(byte[] val) {
		Bindings.UpdateFeeSetChannelId(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 32)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public static UpdateFee of(byte[] channel_id_arg, int feerate_per_kw_arg) {
		long ret = Bindings.UpdateFeeNew(InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(channel_id_arg, 32)), feerate_per_kw_arg);
