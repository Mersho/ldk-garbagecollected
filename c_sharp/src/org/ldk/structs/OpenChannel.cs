...
public class OpenChannel : CommonBase {
	...
	public void set_chain_hash(byte[] val) {
		Bindings.OpenChannelSetChainHash(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 32)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_temporary_channel_id(byte[] val) {
		Bindings.OpenChannelSetTemporaryChannelId(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 32)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_funding_pubkey(byte[] val) {
		Bindings.OpenChannelSetFundingPubkey(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 33)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_revocation_basepoint(byte[] val) {
		Bindings.OpenChannelSetRevocationBasepoint(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 33)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_payment_point(byte[] val) {
		Bindings.OpenChannelSetPaymentPoint(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 33)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_delayed_payment_basepoint(byte[] val) {
		Bindings.OpenChannelSetDelayedPaymentBasepoint(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 33)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_htlc_basepoint(byte[] val) {
		Bindings.OpenChannelSetHtlcBasepoint(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 33)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_first_per_commitment_point(byte[] val) {
		Bindings.OpenChannelSetFirstPerCommitmentPoint(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 33)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
