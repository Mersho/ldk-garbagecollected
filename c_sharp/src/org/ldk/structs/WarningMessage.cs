...
public class WarningMessage : CommonBase {
	...
	public void set_channel_id(byte[] val) {
		Bindings.WarningMessageSetChannelId(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 32)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public static WarningMessage of(byte[] channel_id_arg, string data_arg) {
		long ret = Bindings.WarningMessageNew(InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(channel_id_arg, 32)), InternalUtils.encodeString(data_arg));
