...
public class TxAbort : CommonBase {
	...
	public void set_channel_id(byte[] val) {
		Bindings.TxAbortSetChannelId(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 32)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public static TxAbort of(byte[] channel_id_arg, byte[] data_arg) {
		long ret = Bindings.TxAbortNew(InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(channel_id_arg, 32)), InternalUtils.encodeUint8Array(data_arg));
