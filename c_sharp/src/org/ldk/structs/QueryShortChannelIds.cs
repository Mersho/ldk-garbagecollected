...
public class QueryShortChannelIds : CommonBase {
	...
	public void set_chain_hash(byte[] val) {
		Bindings.QueryShortChannelIdsSetChainHash(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 32)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public static QueryShortChannelIds of(byte[] chain_hash_arg, long[] short_channel_ids_arg) {
		long ret = Bindings.QueryShortChannelIdsNew(InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(chain_hash_arg, 32)), InternalUtils.encodeUint64Array(short_channel_ids_arg));
