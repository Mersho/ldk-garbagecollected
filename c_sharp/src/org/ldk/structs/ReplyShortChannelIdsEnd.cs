...
public class ReplyShortChannelIdsEnd : CommonBase {
	...
	public void set_chain_hash(byte[] val) {
		Bindings.ReplyShortChannelIdsEndSetChainHash(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 32)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public static ReplyShortChannelIdsEnd of(byte[] chain_hash_arg, bool full_information_arg) {
		long ret = Bindings.ReplyShortChannelIdsEndNew(InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(chain_hash_arg, 32)), full_information_arg);
