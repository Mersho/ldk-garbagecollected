...
public class OpenChannelV2 : CommonBase {
	...
	public void set_chain_hash(byte[] val) {
		Bindings.OpenChannelV2SetChainHash(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 32)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_temporary_channel_id(byte[] val) {
		Bindings.OpenChannelV2SetTemporaryChannelId(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 32)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_funding_pubkey(byte[] val) {
		Bindings.OpenChannelV2SetFundingPubkey(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 33)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_revocation_basepoint(byte[] val) {
		Bindings.OpenChannelV2SetRevocationBasepoint(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 33)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_payment_basepoint(byte[] val) {
		Bindings.OpenChannelV2SetPaymentBasepoint(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 33)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_delayed_payment_basepoint(byte[] val) {
		Bindings.OpenChannelV2SetDelayedPaymentBasepoint(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 33)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_htlc_basepoint(byte[] val) {
		Bindings.OpenChannelV2SetHtlcBasepoint(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 33)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_first_per_commitment_point(byte[] val) {
		Bindings.OpenChannelV2SetFirstPerCommitmentPoint(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 33)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_second_per_commitment_point(byte[] val) {
		Bindings.OpenChannelV2SetSecondPerCommitmentPoint(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 33)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
