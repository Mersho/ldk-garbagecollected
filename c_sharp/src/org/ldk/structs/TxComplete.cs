...
public class TxComplete : CommonBase {
	...
	public void set_channel_id(byte[] val) {
		Bindings.TxCompleteSetChannelId(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 32)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public static TxComplete of(byte[] channel_id_arg) {
		long ret = Bindings.TxCompleteNew(InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(channel_id_arg, 32)));
