...
public class FundingCreated : CommonBase {
	...
	public void set_temporary_channel_id(byte[] val) {
		Bindings.FundingCreatedSetTemporaryChannelId(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 32)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_funding_txid(byte[] val) {
		Bindings.FundingCreatedSetFundingTxid(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 32)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public void set_signature(byte[] val) {
		Bindings.FundingCreatedSetSignature(this.ptr, InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(val, 64)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
